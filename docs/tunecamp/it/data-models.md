...
- **`zen_users`** / **`zen_cache`**: Tabelle ereditate dal livello di identità Zen rimosso — conservate per compatibilità di schema ma non più scritte. Vedi [FEDERATION.md](./FEDERATION.md) per la cronologia dettagliata.
